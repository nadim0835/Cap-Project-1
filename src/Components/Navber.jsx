...
const Navber = () => {
  ...
  return (
    <nav className=" absolute top-0 left-0 right-0">
      <Container>
        <Flex
          className={`bg-[#3661FC] relative  justify-between lg:items-center hidden  lg:flex items-start lg:flex-row flex-col  py-2
         rounded-e-[20px]`}
        >
          <div className=" h-[42px] w-[200px] bg-[#3661FC]  absolute left-[-200px] top-0"></div>
          ...
          <div className=" flex items-center gap-10">
            ...
            <div className=" flex">
              <a className=" px-4 border-r-[1px] border-r-[#708FFF] " href="#">
        ...
        <Flex
          className={` justify-between lg:items-center py-[17px] items-start bg-white`}
        >
          ...
          {
            // dropDown&&
          <div className={` absolute lg:w-auto w-[60%] bg-white  duration-300   lg:static top-24 h-screen ${dropDown?"left-0":"left-[-500px]"} lg:h-auto `}>
            <ul className=" flex justify-between items-start lg:items-center lg:gap-6 lg:flex-row flex-col ">
              <li className=" font-dmSans text-[16px] text-[#1A1A1A] duration-300 hover:text-[#FE651B] cursor-pointer border-solid border-b-2  w-full lg:w-auto pl-3 py-2 lg:p-0 lg:border-none  ">
